...
public class BleConnectionService {
    ...
    public void disconnect(){
        if(m_gattServer != null){
          ...
          System.out.println("There are currently no devices connected");
            Toast.makeText(m_context, "There are currently no devices connected", Toast.LENGTH_SHORT).show();
        }
    ...
    public void writeToBluetoothSerial(String text)
    {
        if(m_characteristicTX != null)
        {
            ...
            System.out.println("This value will be written to the Arduino: " + text);
