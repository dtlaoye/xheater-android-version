...
public class StaticResources {
    ...
    public static final String UNIQUE_PACKAGE_NAME = "com.xheater.bluetooth.le";
    ...
    public static final String CONNECTION_STATE_DISCONNECTED = "Bluetooth Disconnected";
